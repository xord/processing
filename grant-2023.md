...
本プロジェクトでは次の2つを主な成果物としました。

1. Processing Gem の 本家 Proecssing との互換性向上
2. Ruby によるグラフィックスプログラミングを広める活動

1 については `4. 開発の成果` に、2 については `5.3 Ruby によるグラフィックスプログラミングを広める活動について` にその成果を記載しました。
